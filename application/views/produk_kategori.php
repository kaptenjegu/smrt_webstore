        ...
        <div class="row">
            ...
            <!--div class="col-lg-3">
				...
				<?php //foreach($kategori as $k){ ?>
                    <li class="pb-3">
                        <a href="<?php //echo base_url() . 'produk/kategori/' . $k->id_kategori; ?>" class="text-decoration-none"  <?php if($k->id_kategori == $this->uri->segment(3)) {echo 'style="color: gray;"';}else{echo 'style="color: black;"';}?>>
